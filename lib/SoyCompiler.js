 ...
 */
SoyCompiler.prototype.loadCompiledTemplates = function(inputDir, callbackOrOptions, callback) {
  var self = this
  ...
  findFiles(inputDir, 'soy.js', function (err, files) {
    if (err) {
      ...
      self.loadCompiledTemplateFiles(files, callbackOrOptions, callback)
          .then(function () {
            deferred.resolve()
          })
    }
...
SoyCompiler.prototype.loadCompiledTemplateFiles = function (files, callbackOrOptions, callback) {
  ...
  return this.getSoyVmContext(vmType).loadCompiledTemplateFiles(files, callback)
}
