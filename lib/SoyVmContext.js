...
SoyVmContext.prototype.loadCompiledTemplateFiles = function (files, callback) {
  ...
  var supportFilePromises = getSupportFilePromises(options.soyUtilsPath)
...
/**
 * @param {String} soyUtilsPath - Path to Soyutils JS file
...
function getSupportFilePromises(soyUtilsPath) {
  ...
  var paths = CLOSURE_PATHS.concat([soyUtilsPath])
